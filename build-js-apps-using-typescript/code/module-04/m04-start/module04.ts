...
/*  EXERCISE 1
    Declare a new function type for the sortDescending and sortAscending functions. */

/*  Convert the sortDescending and sortAscending functions to arrow 
    functions. */

/*  sortDescending is a comparison function that tells the sort method how to sort 
    numbers in descending order */
type sortOrderType = (a: number, b: number) => number;
const sortDescending: sortOrderType = (a: number, b: number): number => {
  if (a > b) {
    return -1;
  } else if (b > a) {
    return 1;
...
const sortAscending: sortOrderType = (a: number, b: number): number => {
  if (a > b) {
    return 1;
  } else if (b > a) {
    return -1;
