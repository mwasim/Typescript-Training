...
const addNumbers2 = (x, y) => x + y; //Implicit return
...
const addNumbersExp = function (x, y) {
    return x + y;
};
...
const addNumbersWithOptionalParams = (x, y) => {
    if (y === undefined)
        return x;
    return x + y;
};
console.log("addNumbersWithOptionalParams(7,8): ", addNumbersWithOptionalParams(7, 8));
console.log("\n");
/*
    Default Parameters
*/
console.log("Default Parameters Demo:");
const addNumbersWithDefaultParams = (x, y = 25) => {
    if (y === undefined)
        return x;
    return x + y;
};
console.log("addNumbersWithDefaultParams(8,9): ", addNumbersWithDefaultParams(8, 9));
...
*/
console.log("Default Parameters Demo:");
const addAllNumbers = (firstNumber, ...restOfNumbers) => {
...
console.log("displayMessage({sender: 'John', text: 'Hello World!'}): ", displayMessage({ sender: "John", text: "Hello World!" }));
console.log("\n");
/*
     Function types
...
const addNumbersCalc = (x, y) => x + y;
const subtractNumbersCalc = (x, y) => x - y;
...
const doCalculation = (operation) => {
    if (operation === "add")
        return addNumbersCalc;
    else
        return subtractNumbersCalc;
};
...
const addNumbersICalc = (x, y) => x + y;
const subtractNumbersICalc = (x, y) => x - y;
console.log("addNumbersICalc(5,3): ", addNumbersICalc(5, 3));
console.log("subtractNumbersICalc(5,3): ", subtractNumbersICalc(5, 3));
//You can also use the calculator function type to pass values from another function.
const doICalculation = (operation) => {
    if (operation === "add")
        return addNumbersICalc;
    else
        return subtractNumbersICalc;
};
